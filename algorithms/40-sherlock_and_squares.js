...
function squares(a, b) {
    ...
    const upperBoundary = Math.sqrt(b);
    const lowerBoundary = Math.sqrt(a);
    
    // if(upperBoundary - lowerBoundary > 0){
        return Math.floor(upperBoundary) - Math.ceil(lowerBoundary) + 1;
    // }
    // else if(Math.ceil(lowerBoundary) * Math.ceil(lowerBoundary) === a){
    //     return 1;
    // }else{
    //     return 0;
    // }
